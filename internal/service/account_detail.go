...
type IAccountDetailsService interface {
	...
	GetAccountDetails(accountId string) (*model.AccountDetail, error)
	GetAllAccountsDetails(userId string) (*[]model.AccountDetail, error)
...
func (ad accountDetailsService) GetAccountDetails(accountId string) (*model.AccountDetail, error) {
...
func (ad accountDetailsService) GetAllAccountsDetails(userId string) (*[]model.AccountDetail, error) {
