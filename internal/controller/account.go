...
type accountController struct {
	accountDetailsService     service.IAccountDetailsService
	accountTransactionService service.IAccountTransactionService
}

// NewAccountController instantiates Account Controller
func NewAccountController() IAccountController {
	return &accountController{
		accountDetailsService:     service.NewAccountDetailsService(),
		accountTransactionService: service.NewAccountTransactionService(),
	}
}
